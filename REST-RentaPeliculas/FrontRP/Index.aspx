<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="FrontRP.Index" %>
    ...
    <form id="form1" runat="server">
        <div class="divaux">
                     ...
                     <h1 class="titIndex" style="text-align:center; font-family: 'Mongolian Baiti'; font-size: xx-large; font-weight: bold; font-style: normal; line-height: normal; white-space: normal;">Renta de Películas </h1>
                        <asp:Menu ID="Menu1" runat="server" ForeColor="White" Orientation="Horizontal" CssClass="Menu" BorderColor="#003366" BorderWidth="3px" BackColor="#3366FF">
                            <Items>
                                <asp:MenuItem NavigateUrl="~/Cliente.aspx" Text="1. Gestión Clientes" Value="Gestión Clientes"></asp:MenuItem>
                                <asp:MenuItem NavigateUrl="~/Membresia.aspx" Text="2. Gestión Membresías" Value="Gestión Membresías"></asp:MenuItem>
                                <asp:MenuItem NavigateUrl="~/Pelicula.aspx" Text="3. Gestión Peliculas" Value="Gestión Peliculas"></asp:MenuItem>
                                <asp:MenuItem NavigateUrl="~/FichaRenta.aspx" Text="4. Gestión Fichas Renta" Value="Gestión Fichas Renta"></asp:MenuItem>
                            </Items>
